...
# Padrao V7 resiliente: carrega credenciais/env_RENATOMEZZALIRA_P1.env, normaliza o relatorio exclusivo, aplica metricas e otimizações seguras.
...
RELATORIO_SAVED_VALUE = "96836102112838540"
