...
def escrever_aba_resumo_execucao(
    ...
    escrever_linha_resumo(
        ws,
        ["RELATORIO", "RESPONSAVEL", "PAGINAS", "DOWNLOADS_OK", "SEM_EDIT_OU_ERRO", "ARQUIVOS_GERADOS"],
        cabecalho=True,
    )
    ...
    for resumo in resumos_execucao or []:
        ...
        escrever_linha_resumo(
            ...
            [
                relatorio,
                responsavel_por_relatorio.get(relatorio, ""),
...
def consolidar_arquivos_download_execucao(resumos_execucao=None, inicio_execucao=None):
    ...
    if not ARQUIVOS_DOWNLOAD_EXECUCAO:
        print("[CONSOLIDADO] Nenhum arquivo da execução atual para consolidar.")
        return None
