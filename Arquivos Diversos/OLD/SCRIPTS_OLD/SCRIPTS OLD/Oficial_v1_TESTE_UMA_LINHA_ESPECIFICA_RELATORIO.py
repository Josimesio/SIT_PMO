...
# No modo teste, reduz a configuração para apenas 1 relatório e apenas 1 linha.
...
def processar_todas_as_paginas(page, relatorio):
    ...
    if MODO_TESTE_LINHA_ESPECIFICA:
        ...
        print("=" * 100)
        print("[MODO TESTE] Execução limitada a uma única linha.")
...
def run():
    ...
    if MODO_TESTE_LINHA_ESPECIFICA:
        print("[MODO TESTE] Ativo: o script vai processar somente uma linha específica.")
