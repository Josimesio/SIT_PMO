...
def enriquecer_csv_com_cenario(caminho, identificador, nome, lider_cenario, status_edit_cenario, numero_pagina, origem_linha):
    ...
    # LIDER_CENARIO | STATUS_EDIT_CENARIO | IDENTIFICADOR_CENARIO | NOME_CENARIO | PAGINA_APEX | ORIGEM_LINHA | demais colunas
...
def enriquecer_xlsx_com_cenario(caminho, identificador, nome, lider_cenario, status_edit_cenario, numero_pagina, origem_linha):
    try:
        from openpyxl import load_workbook
    except Exception as e:
...
def enriquecer_arquivo_download_com_cenario(
    ...
    try:
        if extensao in {".csv", ".txt"}:
            enriquecer_csv_com_cenario(caminho, identificador, nome, lider_cenario, status_edit_cenario, numero_pagina, origem_linha)
        elif extensao in {".xlsx", ".xlsm"}:
            enriquecer_xlsx_com_cenario(caminho, identificador, nome, lider_cenario, status_edit_cenario, numero_pagina, origem_linha)
        elif extensao == ".xls":
